        ...
        <DataTable.Row style={{ backgroundColor: 'white', height: 70 }}>
          ...
          <DataTable.Cell numeric>
            <Text
              ...
              ${thousands_separators(route.params.market_cap)}
            </Text>
          </DataTable.Cell>
        </DataTable.Row>
        ...
        <DataTable.Row style={{ backgroundColor: 'white', height: 70 }}>
          ...
          <DataTable.Cell numeric>
            <Text
              ...
              ${thousands_separators(route.params.circulating_supply.toFixed(2))}
            </Text>
          </DataTable.Cell>
        </DataTable.Row>
        ...
        <DataTable.Row style={{ backgroundColor: 'white', height: 70 }}>
          ...
          <DataTable.Cell numeric>
            <Text
              ...
              ${route.params.total_supply ? thousands_separators(route.params.total_supply) : 0}
            </Text>
          </DataTable.Cell>
        </DataTable.Row>
        ...
        <DataTable.Row style={{ backgroundColor: 'white', height: 70 }}>
          ...
          <DataTable.Cell numeric>
            <Text
              ...
              ${route.params.max_supply ? thousands_separators(route.params.max_supply) : 0}
            </Text>
          </DataTable.Cell>
        </DataTable.Row>
        ...
        <View style={styles.modalCard}>
          ...
          {Profit_Loss > 0 ? (
            <Text style={styles.soldProfit}>
              You've gained ${parseFloat(Profit_Loss).toFixed(3)}{' '}
            </Text>
          ) : (
            <Text style={styles.soldLoss}>
              You've lost ${parseFloat(Profit_Loss*-1).toFixed(3)}{' '}
            </Text>
          )}
